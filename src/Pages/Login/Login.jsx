                ...
                <form onSubmit={handleSubmit} className="card flex-shrink-0 w-full lg:w-8/12 mx-auto shadow-2xl bg-base-100">
                    <div className="card-body px-14">
                        ...
                        <div className="form-control">
                            ...
                            <div className="flex item-center p-0 ">
                                <div className="mt-2">
                                    <input id="terms" type="checkbox" value="" className="w-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 " required />
                                </div>
