            ...
            <div style={{ gridTemplateColumns: "35% 65%" }} className="grid justify-center items-center h-[100vh]">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card flex-shrink-0 w-full lg:w-8/12 mx-auto">
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 text-[16px]">Sign Up</button>
